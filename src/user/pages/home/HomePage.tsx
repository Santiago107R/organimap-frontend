    ...
    return (
        <div className="p-10 flex flex-col gap-6">
            <div className="flex lg:flex-row justify-between items-center flex-col sm:justify-center gap-10 lg:gap-20">
                <SectionCard title="Título de la tarjeta de ejemplo" description="Esta es una descripción de ejemplo para la tarjeta." textButton="Ver más tarde" img={'/favicon.svg'} url="/example" shadow />
